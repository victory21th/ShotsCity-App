...
@synthesize swipeCellXPositionOffset;
...
- (void)viewDidLoad
{
  ...
  [self setupGestureRecognizers];
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(hideSideSwipeView) name:@"shouldHideSideSwipeView" object:nil];
}
...
- (void)swipe:(UISwipeGestureRecognizer *)recognizer direction:(UISwipeGestureRecognizerDirection)direction
{
  if (recognizer && recognizer.state == UIGestureRecognizerStateEnded)
  {
    ...
    UITableViewCell* cell = [tableView cellForRowAtIndexPath:indexPath];
      ...
      sideSwipeView.tag = indexPath.row;
...
- (void) addSwipeViewTo:(UITableViewCell*)cell direction:(UISwipeGestureRecognizerDirection)direction
{
  ...
  cell.frame = CGRectMake(direction == UISwipeGestureRecognizerDirectionRight ? cellFrame.size.width - self.swipeCellXPositionOffset : -(cellFrame.size.width -self.swipeCellXPositionOffset), cellFrame.origin.y, cellFrame.size.width, cellFrame.size.height);
...
- (void)viewDidUnload
{
  ...
  self.sideSwipeView = nil;
    ...
    [[NSNotificationCenter defaultCenter] removeObserver:self name:@"shouldHideSideSwipeView" object:nil];
}
