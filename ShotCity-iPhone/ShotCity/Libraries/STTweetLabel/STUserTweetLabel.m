...
#import "STUserTweetLabel.h"

@interface STUserTweetLabel()
@property (nonatomic) CGPoint startTouchPoint;
@end

@implementation STUserTweetLabel
            ...
            do
            {
                ...
                if (![postCharacters isEqualToString:@""])
                {
                    ...
                    else
                    {
                        ...
                        else if ([lastPrefix isEqualToString:@"|"] && [regexForbiddenHashtag firstMatchInString:postCharacters options:0 range:NSMakeRange(0, [postCharacters length])])
                        {
                            NSTextCheckingResult *matchFor = [regexForbiddenHashtag firstMatchInString:postCharacters options:0 range:NSMakeRange(0, [postCharacters length])];
