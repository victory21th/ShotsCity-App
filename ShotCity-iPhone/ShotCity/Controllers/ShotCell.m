...
{
    ShotCell *cell;
    UIViewController *controller = [[UIViewController alloc] initWithNibName:@"ShotCell" bundle:nil];
    cell = (ShotCell *)controller.view;
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        [self.btnLocation setTitleColor:[UIColor blackColor] forState:UIControlStateHighlighted];
