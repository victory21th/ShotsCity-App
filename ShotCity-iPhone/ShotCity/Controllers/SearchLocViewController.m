...
#import "SearchLocViewController.h"
#import "Image.h"
#import "ShotCell.h"
#import "ShotDetailViewController.h"
#import "AppDelegate.h"

@interface SearchLocViewController ()

@end

@implementation SearchLocViewController
...
- (void) initView{
    if (showType) {
        ...
        [btnGrid setImage:[UIImage imageNamed:@"btn_grid_press.png"] forState:UIControlStateNormal];
        ...
        [btnGrid setImage:[UIImage imageNamed:@"btn_grid.png"] forState:UIControlStateNormal];
