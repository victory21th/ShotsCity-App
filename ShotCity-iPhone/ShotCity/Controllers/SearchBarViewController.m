...
- (IBAction)toggleBack:(id)sender{
    CGRect basketBottomFrame = self.view.frame;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    if ([self.targetViewController respondsToSelector:@selector(toggleSelectedBar:)]) {
        [(TargetViewController*)self.targetViewController toggleSelectedBar:[dataList objectAtIndex:indexPath.row]];
    }
